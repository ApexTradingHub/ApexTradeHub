# ApexLearn Report — 2026-06-25 09:59

Window: last 30 days (since 2026-05-26)  |  Filter: setup=ALL, ticker=ALL
Market: MIXED — SPY=OK | QQQ=OK | Market=MIXED

**Knowledge base** — 99 lifetime trades  |  WR 56.6%  |  PF 2.286  |  Range 2026-03-17 → 2026-06-19
...
- **30d**: n=30 | WR 50.0% | PF 1.73 | AvgW +7.93% | AvgL -4.58% | Total $+100.50
- **90d**: n=69 | WR 55.1% | PF 2.36 | AvgW +8.86% | AvgL -4.60% | Total $+388.23

## 2. Confirmed Facts (Knowledge Base)

**✅ CONFIRMED (n≥30) — vertrauenswürdige Fakten:**
- **🔵 Breakout**: lifetime WR 57% (n=99, PF 2.286)
- **cat_pocket_pivot**: +13% WR-Lift (with 66% vs without 52%, n_present=32)

**⚠️ TENTATIVE (n=15-30) — Trend, brauche mehr Daten:**
- _(keine)_

**🔍 HYPOTHESIS (n<15) — nur Auffälligkeit, kein Beweis:**
- **gap_gt_2pct**: +11% WR-Lift (with 67% vs without 56%, n_present=9)
- **analyst_upside_gt_15pct**: +46% WR-Lift (with 100% vs without 54%, n_present=5)
- **🔵 Breakout × perf_120_lt_0**: +21% vs setup-baseline (WR 78%, n=9)
...
|---|---|---|---|---|---|
| 🔵 Breakout | 30 | 50.0% | 1.73 | +7.93% | -4.58% |

## 4. Per-Setup Lifetime-Performance (Knowledge)

| Setup | n | WR | PF | AvgWin | AvgLoss | Confidence |
|---|---|---|---|---|---|---|
| 🔵 Breakout | 99 | 56.6% | 2.29 | +8.20% | -4.67% | HIGH |

## 5. Catalyst Effectiveness (Lifetime)

| Catalyst | n_present | WR with | WR without | Lift | Confidence |
|---|---|---|---|---|---|
| analyst_upside_gt_15pct | 5 | 100.0% | 54.3% | +45.7% | LOW |
| cat_pocket_pivot | 32 | 65.6% | 52.2% | +13.4% | HIGH |
| gap_gt_2pct | 9 | 66.7% | 55.6% | +11.1% | LOW |
...
_Filtered: 44 legacy, 7 expired-hold, 28 stale-no-trigger_

| Signal | D+ | Ticker | Setup | Entry | Stop | Target | Score |
|---|---|---|---|---|---|---|---|
| 2026-06-24 | D+1 | TGT | 🔵 Breakout | $138.15 | $131.64 | $150.0 | 137.2 |
| 2026-06-24 | D+1 | KVUE | 🚀 Trend | $18.98 | $16.77 | $26.57 | 123.8 |
| 2026-06-24 | D+1 | LEG | 🔵 Breakout | $11.34 | $10.69 | $12.5 | 117.0 |
| 2026-06-24 | D+1 | SWK | 🔵 Breakout | $88.43 | $83.58 | $97.5 | 116.6 |
| 2026-06-24 | D+1 | LII | 🔵 Breakout | $544.76 | $514.57 | $600.0 | 113.7 |
| 2026-06-24 | D+1 | MHK | 🔵 Breakout | $116.26 | $109.07 | $130.0 | 105.5 |
| 2026-06-24 | D+1 | TECH | 🔵 Breakout | $58.68 | $55.03 | $65.0 | 90.5 |
| 2026-06-22 | D+3 | TSM | 🔵 Breakout | $466.15 | $439.03 | $520.71 | 123.7 |
| 2026-06-22 | D+3 | SW | 🔵 Breakout | $45.67 | $43.04 | $51.6 | 114.8 |
| 2026-06-22 | D+3 | ABBV | 🔵 Breakout | $230.93 | $221.72 | $250.0 | 98.7 |
| 2026-06-22 | D+3 | D | 🚀 Trend | $68.84 | $59.65 | $87.37 | 92.4 |
| 2026-06-22 | D+3 | JCI | 🔵 Breakout | $149.68 | $142.62 | $164.1 | 91.3 |
| 2026-06-22 | D+3 | NVO | 🔵 Breakout | $46.14 | $43.9 | $50.0 | 83.3 |

## 12. Window-vs-Lifetime Drift (worth investigating?)

- TOTAL WR last-30d (50.0%) vs lifetime (56.6%): 📉 worse by 6.6pp
